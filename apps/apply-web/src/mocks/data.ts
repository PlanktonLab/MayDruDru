...
export const PAYMENT_CHANNELS: SchemePaymentChannel[] = [
  {
    code: 'CREDIT_CARD',
    label: '信用卡繳費',
    hint: '用信用卡直接扣款，包含綁在 App Store、Google Play 等平台上的信用卡。',
    example: '例如：VISA／MasterCard／JCB 等各家信用卡',
  ...
  },
  {
    code: 'TELECOM',
    label: '電信繳費',
    hint: '由電信公司代收，費用出現在你的電信帳單上。',
    example: '例如：中華電信、台灣大哥大、遠傳等電信帳單代收',
  ...
  },
  {
    code: 'E_PAYMENT',
    label: '電子支付工具繳費',
    hint: '透過電子支付帳戶付款。支付帳戶須為申請人本人。',
    example: '例如：LINE Pay、街口支付、PayPal、悠遊付等',
  ...
  },
  {
    code: 'OTHER',
    label: '其他繳費',
    hint: '以上都不是，例如轉帳、金融卡或其他方式。支付帳戶須為申請人本人。',
    example: '例如：銀行轉帳、金融卡、其他支付方式',
    required_document_type_codes: ['PAYER_ACCOUNT_PROOF', 'TRANSACTION_DETAIL'],
...
export const FAQS: Faq[] = [
  ...
  {
    id: 'faq_official_receipt',
    category: 'DOCUMENTS',
    priority: 95,
    question: '「官方收據」需要包含哪些內容才算合格？',
    answer:
      '官方收據（或發票、訂單確認信）須清楚載明以下資訊：\n1. 訂閱人姓名或訂閱人之電子信箱（Email）\n2. 完整 AI 工具名稱（非僅標示雲端儲存空間）\n3. 軟體公司名稱\n4. 訂閱日期、訂閱期間或續訂日期\n5. 原始費用與付款方式',
  },
  {
    id: 'faq_monthly_accumulation',
    category: 'DOCUMENTS',
    priority: 90,
    question: '月費制可以累積多個月份一起提出申請嗎？',
    answer:
      '可以。\n\n申請月費制 AI 工具補助者，可累積連續月份之訂閱費用，並於累積訂閱之最後一個月提出申請；惟訂閱期間不得中斷（不得跨月），且應逐月檢附官方收據或訂閱憑證、臺幣換算證明及繳款憑證。',
  },
  {
    id: 'faq_proxy_payment',
    category: 'DOCUMENTS',
    priority: 90,
    question: '我未持有信用卡，可以由父母、配偶或法定代理人代為支付嗎？',
    answer:
      '可以。\n\n申請人如未持有信用卡，由法定代理人（或父母、配偶）代為支付款項者：\n1. 應檢附身分關係證明文件（如戶口名簿、戶籍謄本或其他足資證明之文件）。\n2. 應由申請人與代付款人共同親筆簽名切結書（詳附件四）後拍照上傳。',
  },
  {
    id: 'faq_card_photo',
    category: 'DOCUMENTS',
  ...
  {
    id: 'faq_application_deadline',
    category: 'PROCESS',
    priority: 100,
    question: '購買 AI 工具後，最晚要在多久以內提出線上申請？',
    answer:
      '自 115 年 8 月 14 日起開放線上申請，購買後之申請期限為：\n• 月費制：購買日期起「一個月內」提出申請。\n• 年費制：購買日期起「兩個月內」提出申請。\n\n受理期間至 115 年 11 月 30 日截止或經費用罄止，超過規定期限將不予受理。',
  },
  {
    id: 'faq_revision_queue',
    category: 'PROCESS',
    priority: 90,
    question: '被退件補傳之後，是不是要重新排隊？補正有期限嗎？',
    answer:
      '不用重新排隊。補件後你的案件依「第一次送件的時間」排序，不會回到隊伍最後面。\n\n【重要補件期限】：申請文件有欠缺經通知補正者，最遲應於通知起「10 日（工作天）」內完成補正（工作天係指依政府機關辦公日曆表規定應出勤上班之日）。逾期未完成將不予核撥補助。',
  },
  {
    id: 'faq_application_limit',
    category: 'PROCESS',
    priority: 85,
    question: '同一個人每年可以申請幾次？一次能申請多套工具嗎？',
    answer:
      '同一申請人於本計畫內，每年最多以補助一次為限（僅限購買一次 AI 軟體工具）。\n\n同一筆支出不得重複向市府其他單位或政府機關請領相同補助。若經查核有不實申請，必要時將依法函送司法機關，並列管 1 至 5 年內不予受理。',
  },
  {
    id: 'faq_eligible_tool',
    category: 'TOOLS',
    priority: 100,
    question: '我買的 AI 工具可以申請嗎？哪些軟體不予補助？',
    answer:
      '在申請第一步輸入工具名稱即可查驗。若系統尚未收錄，仍可送件由承辦人員人工認定。\n\n【依規章不予補助項目】：\n1. 購買中國大陸（含港澳）地區開發或營運之 AI 工具、軟體及相關服務。\n2. 不補助以預付儲值、購買使用額度（Credit）、點數、代幣（Token）或 API（Application Programming Interface）額度等方式取得之服務（凡採預先儲值、依實際使用量扣抵者均不補助）。',
  },
  {
    id: 'faq_api_token',
    category: 'TOOLS',
  ...
  },
  {
    ...
    answer:
      '申請人須為設籍新竹市 16 歲(含)至 40 歲(含)以下新竹市青年（出生日期於民國 74 年 4 月 3 日（含）至民國 99 年 4 月 2 日（含）之間）。\n\n申請時需檢附身分證正反面照片，且須能清楚辨識設籍於新竹市。',
  },
  {
    id: 'faq_amount',
    category: 'ELIGIBILITY',
